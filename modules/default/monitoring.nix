...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    services = {
      ...
      declarative-jellyfin.system.enableMetrics = true;
        ...
        // {
          "go.d/prometheus.conf" = pkgs.writers.writeYAML "prometheus.conf" {
            jobs =
              ...
              ++ lib.optional config.services.declarative-jellyfin.system.enableMetrics {
                name = "Jellyfin";
                url = "http://127.0.0.1:${toString config.services.declarative-jellyfin.network.internalHttpPort}/metrics";
              }
