{ colors, config, ... }: {
  ...
  services.swaync = {
    ...
    settings = {
      ...
      # TODO HYPRLAND set primary screen `notification-window-preferred-output`
      ...
      widgets = [ "mpris" "title" "notifications" ];
    ...
    style = ''
      * {
      ...
      .notification-row {
        margin-top: -${toString (10 - 2 * config.wayland.windowManager.hyprland.settings.general.border_size)}px;
      }
