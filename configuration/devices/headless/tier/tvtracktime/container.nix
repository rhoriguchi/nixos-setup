...
in
{
  ...
  containers.tvtracktime = {
    ...
    # TODO figure out how to make this work with mounts
    # privateUsers = "pick";

    bindMounts = {
      # TODO figure out backup strategy
    ...
    config = {
      ...
      virtualisation.oci-containers.containers = {
        ...
        backend = {
          image = "ghcr.io/rhoriguchi/tvtracktime/backend:1.1.8";
        ...
        frontend = {
          image = "ghcr.io/rhoriguchi/tvtracktime/frontend:1.1.8";
