  ...
  services = {
    ...
    rustdesk-server = {
      ...
      signal = {
        ...
        extraArgs = [ "--key" secrets.rustdesk.publicKey "--mask" "192.168.0.0/16" ];
      };

      relay.extraArgs = [ "--key" secrets.rustdesk.publicKey ];
    };
  };

  systemd.tmpfiles.rules =
    [ "L+ /var/lib/rustdesk/id_ed25519 - - - - ${privateKey}" "L+ /var/lib/rustdesk/id_ed25519.pub - - - - ${publicKey}" ];
