  ...
  (_: super: {
    ...
    superfile = super.callPackage (import "${
        super.fetchFromGitHub {
          owner = "NixOS";
          repo = "nixpkgs";
          rev = "6c49f13575b9b639ab80629c6a1d3a862476a9bf";
          sha256 = "sha256-11xhlnknk63XEGawD7z2KBOtscPVxabK6tvx5Ta5we4=";
        }
    ...
    # TODO remove when merged https://nixpk.gs/pr-tracker.html?pr=411034
    adguardhome = super.callPackage (import "${
        super.fetchFromGitHub {
          owner = "NixOS";
          repo = "nixpkgs";
          rev = "a7160b00117aac9f3e84d5e2269bcd83964f70af";
          sha256 = "sha256-6d/hYWdhyxnwU6BG9kb7BeMgjvJ0iuXUZjXtc6WOg9c=";
        }
